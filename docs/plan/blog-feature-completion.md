...
| 1.2 搜索关键词连接后端 | 已完成 | 无 | 2026-06-09 | 2026-06-09 | keyword 映射为 title 传给 API |
| 1.3 文件管理列表连接后端 | 已完成 | 无 | 2026-06-08 | 2026-06-08 | |
| 1.4 评论管理添加删除按钮 | 已完成 | 无 | 2026-06-08 | 2026-06-08 | |
| 2.1 上一篇/下一篇导航 | 已完成 | 无 | 2026-06-09 | 2026-06-09 | prevPost/nextPost 已在类型/API/mapper/UI 中实现 |
| 2.2 Markdown 实时预览 | 已完成 | 无 | 2026-06-08 | 2026-06-08 | |
| 2.3 标签编辑功能 | 已完成 | 无 | 2026-06-09 | 2026-06-09 | updateBlogTag API + 编辑 Modal + 管理端路由 |
| 2.4 评论管理回复功能 | 已完成 | 无 | 2026-06-09 | 2026-06-09 | |
| 2.5 友链页面+管理 | 已完成 | 后端 2.2 | 2026-06-09 | 2026-06-09 | 前端实现完成，待后端 API 就绪后联调 |
| 2.6 封面图上传按钮 | 已完成 | 无 | 2026-06-08 | 2026-06-08 | |
| 3.1 头像自动生成 | 已完成 | 无 | 2026-06-09 | 2026-06-09 | authorAvatar 已在类型/API/UI 中实现，补充邮箱提示文案 |
| 3.2 软删除/回收站 | 已完成 | 后端 3.1 | 2026-06-10 | 2026-06-10 | BlogPostStatus 添加 deleted + 回收站 UI + restore/permanentDelete API + 管理端路由 |
| 3.3 评论隐藏状态 | 已完成 | 后端 2.3 | 2026-06-10 | 2026-06-10 | BlogComment 添加 isHidden + hide/unhide API + 管理端隐藏/取消隐藏按钮 + 状态筛选 + 前台过滤 |
